	...
	function renderSectionOne() {
		return (
			<View
				...
				<InfoItem label="Full Name" value="Kevin Hernandez" />
	...
	function renderSectionTwo() {
		return (
			<View
				...
				<InfoItem label="Date of Birth" value="03/03/1990" />

				<InfoItem label="Gender" value="Male" />

				<InfoItem label="Joined" value="March 2017" />

				<InfoItem label="Email" value="byprogrammers@gmail.com" />
